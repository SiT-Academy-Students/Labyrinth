...
namespace Labyrinth.Console
{
    public class MapGenerator
    {
        ...
        public void GenerateXAxisBorders(int cycleStart, int cycleEnd, ObstacleEdges edgeOrientation)
        {
        ...
        public void GenerateYAxisBorders(int cycleStart, int cycleEnd, ObstacleEdges edgeOrientation)
        {
